...
def abrir_tela_manutencao():
    ...
    campos = [
        ("ID Manutenção", 0), ("ID Caminhão", 1), ("Data Início", 2), ("Data Fim", 3), ("Serviço", 4),
        ("Mecânico", 5), ("ID Peça", 6)
    ]
    entradas = []
    ...
    def atualizar_lista():
        ...
        for m in dados:
            ...
            lista.insert(tk.END, f"Serviço: {m.get('servico', '')} | ID do Mecânico: {m.get('mecanico', '')} | Peça: {m.get('idPeca', '')}")
